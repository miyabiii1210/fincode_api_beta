...
func PaymentCancel(ctx context.Context, internal *PaymentCancelRequest, orderId string) (*PaymentCancelResponse, error) {
	path := fmt.Sprintf("/v1/payments/%s/cancel", orderId)
